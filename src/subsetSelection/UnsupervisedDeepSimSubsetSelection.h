#ifndef SRC_SUBSETSELECTION_UNSUPERVISEDDEEPSUBSETSELECTION_H_
#define SRC_SUBSETSELECTION_UNSUPERVISEDDEEPSUBSETSELECTION_H_
...
class UnsupervisedDeepSubsetSelection {
 protected:
 ...
 public:
    UnsupervisedDeepSubsetSelection(std::vector<cv::Mat>& ImageCollection, std::vector<std::string>& ImageCollectionName, CaffeClassifier& cc, std::string featureLayer,
...
#endif  // SRC_SUBSETSELECTION_UNSUPERVISEDSUBSETSELECTION_H_
